...
DigitPattern leftPattern = {
    {{0x00, 0x00}, {0x02, 0x00}, {0x04, 0x08}, {0x06, 0x0F}, {0x08, 0x3F}, {0x0a, 0x0F}, {0x0c, 0x08}, {0x0e, 0x00}}
};

DigitPattern upPattern = {
    {{0x00, 0x00}, {0x02, 0x04}, {0x04, 0x04}, {0x06, 0x04}, {0x08, 0x2A}, {0x0a, 0x1C}, {0x0c, 0x04}, {0x0e, 0x00}}
};

DigitPattern downPattern = {
    {{0x00, 0x00}, {0x02, 0x04}, {0x04, 0x1C}, {0x06, 0x2A}, {0x08, 0x04}, {0x0a, 0x04}, {0x0c, 0x04}, {0x0e, 0x00}}
};
